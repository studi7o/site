...
``` sh
ffmpeg -threads 4 -re -fflags +genpts -stream_loop -1 -i 李宗盛\ -\ 山丘.mp4 -c:v libx264 -preset veryfast -maxrate 3000k -bufsize 6000k -pix_fmt yuv420p -g 50 -b:a 160k -ac 2 -ar 44100 -f flv "rtmp://txy.live-send.acg.tv/live-txy/?streamname=live_260695516_5087588&key=2212691e9bbd3c377c41565413137071"
```
...
AVCodecContext AVOptions:
  ...
  -color_primaries   <int>        ED.V.... color primaries (from 1 to 22) (default unknown)
     bt709                        ED.V.... BT.709
  ...
  -color_trc         <int>        ED.V.... color transfer characteristics (from 1 to 18) (default unknown)
     bt709                        ED.V.... BT.709
     unknown                      ED.V.... Unspecified
     ...
     smpte428_1                   ED.V.... SMPTE 428-1
  -colorspace        <int>        ED.V.... color space (from 0 to 11) (default unknown)
     rgb                          ED.V.... RGB
     bt709                        ED.V.... BT.709
     unknown                      ED.V.... Unspecified
     fcc                          ED.V.... FCC
  ...
  -color_range       <int>        ED.V.... color range (from 0 to 2) (default unknown)
     unknown                      ED.V.... Unspecified
  ...
  -chroma_sample_location <int>        ED.V.... chroma sample location (from 0 to 6) (default unknown)
     unknown                      ED.V.... Unspecified
     left                         ED.V.... Left
     center                       ED.V.... Center
...
amv encoder AVOptions:
  ...
  -pred              <int>        E..V.... Prediction method (from 1 to 3) (default left)
     ...
     plane                        E..V....
     median                       E..V....
  -huffman           <int>        E..V.... Huffman table strategy (from 0 to 1) (default default)
     default                      E..V....
     optimal                      E..V....
...
h264_crystalhd AVOptions:
  -crystalhd_downscale_width <int>        .D.V.... Turn on downscaling to the specified width (from 0 to UINT32_MAX) (default 0)

H264 VDPAU Decoder AVOptions:
  -enable_er         <boolean>    .D.V.... Enable error resilience on damaged frames (unsafe) (default auto)
...
mpeg4_crystalhd AVOptions:
  -crystalhd_downscale_width <int>        .D.V.... Turn on downscaling to the specified width (from 0 to UINT32_MAX) (default 0)

MPEG4 Video VDPAU Decoder AVOptions:

mpeg2_crystalhd AVOptions:
  -crystalhd_downscale_width <int>        .D.V.... Turn on downscaling to the specified width (from 0 to UINT32_MAX) (default 0)
...
SMPTE 302M Decoder AVOptions:
  -non_pcm_mode      <int>        .D.V.... Chooses what to do with NON-PCM (from 0 to 3) (default decode_drop)
     copy                         .D.V.... Pass NON-PCM through unchanged
     drop                         .D.V.... Drop NON-PCM
     decode_copy                  .D.V.... Decode if possible else passthrough
     decode_drop                  .D.V.... Decode if possible else drop
...
Opus encoder AVOptions:
  -opus_delay        <float>      E...A... Maximum delay (and lookahead) in milliseconds (from 2.5 to 360) (default 360)
...
libzvbi_teletextdec AVOptions:
  -txt_page          <string>     .D...S.. list of teletext page numbers to decode, * is all (default "*")
  -txt_chop_top      <int>        .D...S.. discards the top teletext line (from 0 to 1) (default 1)
  -txt_format        <int>        .D...S.. format of the subtitles (bitmap or text) (from 0 to 1) (default bitmap)
     bitmap                       .D...S..
     text                         .D...S..
  ...
  -txt_duration      <int>        .D...S.. display duration of teletext pages in msecs (from 0 to 8.64e+07) (default 30000)
...
AVFormatContext AVOptions:
  ...
  -flush_packets     <boolean>    E....... enable flushing of the I/O context after each packet (default true)
...
http AVOptions:
  ...
  -user_agent        <string>     .D...... override User-Agent header (default "Lavf/57.71.100")
  -user-agent        <string>     .D...... override User-Agent header (default "Lavf/57.71.100")
...
DV1394 indev AVOptions:
  -standard          <int>        .D......  (from 0 to 1) (default NTSC)
     PAL                          .D...... 
     NTSC                         .D...... 
  -channel           <int>        .D......  (from 0 to INT_MAX) (default 63)
...
Pulse demuxer AVOptions:
  ...
  -name              <string>     .D...... set application name (default "Lavf57.71.100")
...
RTSP demuxer AVOptions:
  ...
  -reorder_queue_size <int>        .D...... set number of packets to buffer for handling of reordered packets (from -1 to INT_MAX) (default -1)
  -buffer_size       <int>        ED...... Underlying protocol send/receive buffer size (from -1 to INT_MAX) (default -1)
  -user-agent        <string>     .D...... override User-Agent header (default "Lavf57.71.100")
...
PulseAudio muxer AVOptions:
  ...
  -name              <string>     E....... set application name (default "Lavf57.71.100")
...
segment muxer AVOptions:
  ...
  -reset_timestamps  <boolean>    E....... reset timestamps at the begin of each segment (default false)
...
acompressor AVOptions:
  ...
  makeup            <double>     ..F.A... set make up gain (from 1 to 64) (default 2)
...
afade AVOptions:
  ...
  nb_samples        <int>        ..F.A... set number of samples for fade duration (from 1 to INT_MAX) (default 44100)
  ns                <int>        ..F.A... set number of samples for fade duration (from 1 to INT_MAX) (default 44100)
...
bs2b AVOptions:
  -profile           <int>        ....A... Apply a pre-defined crossfeed level (from 0 to INT_MAX) (default default)
     default                      ....A... default profile
     cmoy                         ....A... Chu Moy circuit
     jmeier                       ....A... Jan Meier circuit
  -fcut              <int>        ....A... Set cut frequency (in Hz) (from 0 to 2000) (default 0)
  -feed              <int>        ....A... Set feed level (in Hz) (from 0 to 150) (default 0)
...
stereotools AVOptions:
  ...
  mode              <int>        ..F.A... set stereo mode (from 0 to 6) (default lr>lr)
     lr>lr                        ..F.A...
     lr>ms                        ..F.A...
     ms>lr                        ..F.A...
     lr>ll                        ..F.A...
...
blend AVOptions:
  c0_mode           <int>        ..FV.... set component #0 blend mode (from 0 to 31) (default normal)
     addition                     ..FV.... 
     addition128                  ..FV.... 
     and                          ..FV.... 
     average                      ..FV.... 
     ...
     vividlight                   ..FV.... 
     xor                          ..FV.... 
  c1_mode           <int>        ..FV.... set component #1 blend mode (from 0 to 31) (default normal)
     addition                     ..FV.... 
     addition128                  ..FV.... 
     and                          ..FV.... 
     average                      ..FV.... 
     ...
     vividlight                   ..FV.... 
     xor                          ..FV.... 
  c2_mode           <int>        ..FV.... set component #2 blend mode (from 0 to 31) (default normal)
     addition                     ..FV.... 
     addition128                  ..FV.... 
     and                          ..FV.... 
     average                      ..FV.... 
     ...
     vividlight                   ..FV.... 
     xor                          ..FV.... 
  c3_mode           <int>        ..FV.... set component #3 blend mode (from 0 to 31) (default normal)
     addition                     ..FV.... 
     addition128                  ..FV.... 
     and                          ..FV.... 
     average                      ..FV.... 
     ...
     vividlight                   ..FV.... 
     xor                          ..FV.... 
  all_mode          <int>        ..FV.... set blend mode for all components (from -1 to 31) (default -1)
     addition                     ..FV.... 
     addition128                  ..FV.... 
     and                          ..FV.... 
     average                      ..FV.... 
  ...
  repeatlast        <boolean>    ..FV.... repeat last bottom frame (default true)
...
colorspace AVOptions:
  all               <int>        ..FV.... Set all color properties together (from 0 to 8) (default 0)
     ...
     smpte240m                    ..FV.... 
     bt2020                       ..FV.... 
  space             <int>        ..FV.... Output colorspace (from 0 to 11) (default 2)
     bt709                        ..FV.... 
     fcc                          ..FV.... 
     bt470bg                      ..FV.... 
     smpte170m                    ..FV.... 
...
displace AVOptions:
  edge              <int>        ..FV.... set edge mode (from 0 to 2) (default smear)
     blank                        ..FV.... 
     smear                        ..FV.... 
     wrap                         ..FV.... 
...
drawtext AVOptions:
  ...
  fontsize          <int>        ..FV.... set font size (from 0 to INT_MAX) (default 0)
  ...
  fix_bounds        <boolean>    ..FV.... check and fix text coords to avoid clipping (default true)
...
histogram AVOptions:
  ...
  display_mode      <int>        ..FV.... set display mode (from 0 to 1) (default parade)
     parade                       ..FV....
     overlay                      ..FV....
  d                 <int>        ..FV.... set display mode (from 0 to 1) (default parade)
     parade                       ..FV....
     overlay                      ..FV....
...
maskedclamp AVOptions:
  undershoot        <int>        ..FV.... set undershoot (from 0 to INT_MAX) (default 0)
  overshoot         <int>        ..FV.... set overshoot (from 0 to INT_MAX) (default 0)
  planes            <int>        ..FV.... set planes (from 0 to 15) (default 15)
...
overlay AVOptions:
  ...
  shortest          <boolean>    ..FV.... force termination when the shortest input terminates (default false)
  format            <int>        ..FV.... set output format (from 0 to 4) (default yuv420)
     yuv420                       ..FV.... 
     yuv422                       ..FV.... 
     yuv444                       ..FV.... 
     rgb                          ..FV.... 
...
avectorscope AVOptions:
  ...
  zoom              <double>     ..FV.... set zoom factor (from 1 to 10) (default 1)
